...
import org.usfirst.frc.team7068.robot.Constants;
...
public class DriveTrain extends Subsystem {
  ...
  //Arcade Drive from Drive via XboxController input   
    public void arcadeDrive(XboxController joystick1) {
    	double joyThreshold = 0.1;  //default threshold value from xBox Controller
    	double stickX = joystick1.getX() * 0.7;       
    	double stickY = joystick1.getY() * -1 * 0.8;
